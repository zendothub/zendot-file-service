...
public class FileController {
     ...
     @Autowired
     private DomainBucketRepository domainBucketRepository;
    ...
    public ResponseEntity<UploadedFile> handleFileUpload(
        ...
        if (authentication != null && authentication.getPrincipal() instanceof DomainBucketModel) {
            DomainBucketModel domainValueModel = (DomainBucketModel) authentication.getPrincipal();
